...
<body>
    ...
    <br>
    <form action="usc_feederForm_show_initial.php" method="post">
    ...
    Enter the Feeder Name (Eg: C)<br>
    <input type="text" name="formFeeder" maxlength="50">
    <br><br>What is it affecting<br>
    ...
    <input type="submit" name="formFeederSubmit" value="FeederQuerySubmit">
	</form>
