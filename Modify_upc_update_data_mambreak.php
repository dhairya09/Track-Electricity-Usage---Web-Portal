      ...
      <tr>
        ...
        <?php while($display = mysqli_fetch_assoc($disp)){ ?>
            <tr>
              ...
              <td><a href= "edit_mambreaker.php?mambreaker=<?php echo urlencode($display["Building_Code"]); ?>">Edit</a></td>
              <td><a href= "delete_mambreaker.php?mambreaker=<?php echo urlencode($display["Building_Code"]); ?>" onclick="return confirm('Are you sure?');">Delete</a></td>
            </tr>
        <?php } ?>
      </table>
...
?>
        ...
        <a href="new_mambreaker.php">Add new Mam Breakers Information</a>
        <br/>
