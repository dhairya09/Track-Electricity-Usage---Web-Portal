...
<div class="row2">
    ...
    <div class = "col2">
      ...
      $query = "SELECT T1.Building_Code AS Building, T1.Primary_Feed AS Pri, T1.Secondary_Feed AS Sec, T2.Vault_Name AS Vault, T2.Vault_Section AS Service FROM elec_hof_txdemand T1 LEFT JOIN elec_hof_services T2 ON T1.Primary_Feed = T2.Feeder_Name WHERE T1.Building_Code REGEXP '^[a-l]' ORDER BY 1 ";
      $result = mysqli_query($connection,$query);
      $query2 = "SELECT T1.Building_Code AS Building, T1.Primary_Feed AS Pri, T1.Secondary_Feed AS Sec, T2.Vault_Name AS Vault, T2.Vault_Section AS Service FROM elec_hof_txdemand T1 LEFT JOIN elec_hof_services T2 ON T1.Primary_Feed = T2.Feeder_Name WHERE T1.Building_Code REGEXP '^[m-z]' ORDER BY 1 ";
      $result2 = mysqli_query($connection,$query2);




			echo 'HOF SERVICE BY BUILDING';
			echo '<br><br>';
        ...
        if($data2){
          while($data2 = mysqli_fetch_assoc($result2))
          {
            echo '<table style="width:100%" class="sortable">';
              ...
              //echo "<p style='text-align:center'><b>No Data Records Found for [m-z]</b></p>";
