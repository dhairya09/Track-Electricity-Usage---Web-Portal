...
if(isset($_POST["submit"])){
  ...
  if(empty($errors)){
    ...
    $query = "INSERT into quick_connect_equipment( ";
    ...
    if($result){
      $_SESSION["message"] = "QuickConnectEquipment Information Created";
      redirect_to("Modify_upc_update_data_qce.php");
    }
      $_SESSION["message"] = "QuickConnectEquipment Information Creation Failed";
  }
...
<div class = "row2">
  ...
  <h2>Create QuickConnectEquipment Information</h2>
  <form action="new_qce.php" method="post">
    <p>Building_Code:
    ...
    <input type="submit" name="submit" value="Create QuickConnectEquipment Information" />
  </form>
