...
<div class="row2">
    ...
    <div class = "col2">
			...
			<button class="btn btn-success" onClick ="printDiv('printableAreaFull')">PDF Export Booklet</button>
			<div id="printableAreaFull">
			<!--Beigler-->
			<!-- 1 -->
								...
								<?php
									...
									?>
											...
											<tr>
												...
												<td align="center" colspan="5" width = 1%><a style="text-decoration: none" <?php echo 'href="data/'.(substr($varA1,0,3)).'.php"'  ?>><?php echo $varA1 ?></a></td>
												...
												<td align="center" colspan="5" width = 1%><a style="text-decoration: none" <?php echo 'href="data/'.(substr($varB1,0,3)).'.php"'  ?>><?php echo $varB1 ?></a></td>
									...
									<div id="printableArea11">
														...
														<?php
																while($counter < 20){
																	...
																	$display2 = mysqli_fetch_assoc($res_T_Prim);
															...
															?>
																...
																while($counter < 15){
																	...
																	$display2 = mysqli_fetch_assoc($res_T_Sec);
