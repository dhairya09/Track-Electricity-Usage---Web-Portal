    ...
    <div class = "col2">
      ...
      <div id="printableArea1">
                ...
                <?php
                  ...
                  $query = "SELECT T1.Building_Code AS Building, T1.Primary_Feed AS Pri, T1.Secondary_Feed AS Sec, T2.Vault_Name AS Vault, T2.Vault_Section AS Service FROM elec_VLG_TXDEMAND T1 LEFT JOIN elec_VLG_SERVICES T2 ON T1.Primary_Feed = T2.Feeder_Name WHERE T1.Building_Code REGEXP '^[a-l]' ORDER BY 1 ";
