...
<div class="row2">
    ...
    <div class = "col2">
      ...
      <div Class="sidebar">
	      ...
	      $query = "SELECT * FROM view_txdemand_oth ORDER BY Building ASC";
	      ...
	      if($result){
            ...
            echo'<th>Building</th><th>Ckt_P</th><th>Ckt_S</th><th>Fed_Through</th><th>kVA</th><th>Peak_kW</th><th>Peak_Usage</th><th>Voltage</th><th>Rotation</th><th>Device_Number</th><th>Level</th><th>Priority</th><th>Manufacturer</th><th>Type</th><th>Imp</th><th>Year</th><th>Capacity</th>';
              ...
              echo'</tr>';
                ...
                echo "<p style='text-align:center;border-color:black;border-width:2px;border-style:solid;border-collapse:collapse;'><b>No VLG-Offcampus Transformer Information Found</b></p>";
	        }
