    ...
    <div class = "col2">
      ...
      <div id="printableArea12">
              ...
              <?php
                ...
                $res_I_Prim = Booklet_VLG_Data('VM');
                $res_J_Prim = Booklet_VLG_Data('VN');
                $res_X_Prim = Booklet_VLG_Data('VO');
                $res_Z_Prim = Booklet_VLG_Data('VP');
            ...
            <?php
              ...
              <?php
                  ...
                  $res_I_Sec = Booklet_VLG_Data_Sec('VM');
                  $res_J_Sec = Booklet_VLG_Data_Sec('VN');
                  $res_X_Sec = Booklet_VLG_Data_Sec('VO');
                  $res_Z_Sec = Booklet_VLG_Data_Sec('VP');
              ?>
        ...
        <br>
        <form action="Modify_vlg_mvdistribution_booklet.php"><input type="submit" value="VLG MVDistribution Booklet Print"></form>
