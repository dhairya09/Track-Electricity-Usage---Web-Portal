    ...
    <div class = "col2">
      ...
      <div Class="sidebar">
          <a class="heading1" href="Modify_data.php">BACK</a>
			...
			<?php
			$query = "SELECT * FROM elec_uof_services ORDER BY Feeder_Name ASC";
      ...
      if($result){
        ...
        if($data){
          while($data = mysqli_fetch_assoc($result))
          {
              ...
              echo "<p style='text-align:center;border-color:black;border-width:2px;border-style:solid;border-collapse:collapse;'><b>No UOF Records Found</b></p>";
        }
      }
