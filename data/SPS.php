...
<br>
<?php
$result = mysql_query("SELECT * FROM elec_HSC_BUILDINGS WHERE Bldg_Cd_1 LIKE '%".$thisBuildingCode."%'");
if(mysql_num_rows($result)>0)
{
echo '<h2>Associated Buildings</h2>';
echo '<table CLASS="dispTable">';
...
<br>
<?php
$result = mysql_query("SELECT * FROM elec_HSC_VACUUM_TRANSFER_SWITCH WHERE BUILDING_CODE like '%".$thisBuildingCode."%'");
if(mysql_num_rows($result)>0)
{
echo '<h2>VACUUM / TRANSFER SWITCH</h2>';
echo '<table CLASS="dispTable">';
...
<br>
<?php
$result = mysql_query("SELECT * FROM view_txdemand_hsc WHERE Building like '%".$thisBuildingCode."%'");
if(mysql_num_rows($result)>0)
{
echo '<h2>TX Demand - HSC</h2>';
echo '<table CLASS="dispTable">';
echo'<th>Building</th><th>Ckt_P</th><th>Ckt_S</th><th>Fed_Through</th><th>kVA</th><th>Peak_kW</th><th>Peak_kW_Prev_Month</th><th>Peak_kW_Prev_Year</th><th>Peak_Usage</th><th>Voltage</th><th>Rotation</th><th>Device_Number</th><th>Level</th><th>Priority</th><th>Manufacturer</th><th>Type</th><th>Imp</th><th>Year</th><th>Capacity</th>';
...
<br>
<?php
$result = mysql_query("SELECT * FROM view_generators_hsc WHERE Bldg LIKE'%".$thisBuildingCode."%'");
if(mysql_num_rows($result)>0)
{
echo '<h2>Generators - HSC</h2>';
echo '<table CLASS="dispTable">';
echo'<th>Bldg</th><th>Building</th><th>Equipment</th><th>Nomenclature</th><th>Floor</th><th>kW</th><th>kVA</th><th>Output_Voltage</th><th>Manufacturer</th><th>Mfrd_Year</th><th>Engine_Type</th><th>Fuel_In_Gallons</th><th>Fuel_Type</th><th>Location</th><th>Keyword</th>';
...
<br>
<?php
$result = mysql_query("SELECT * FROM elec_HSC_GENERATOR_ABOVEGROUND_STORAGE_TANK WHERE Building LIKE '%".$thisBuildingCode."%'");
if(mysql_num_rows($result)>0)
{
echo '<h2>Generator Above Ground Storage Tank</h2>';
echo '<table CLASS="dispTable">';
echo'<th>Building</th><th>Location</th><th>Address</th><th>Fuel</th><th>Capacity</th>';

while($data = mysql_fetch_array($result))
{
echo'<tr>';
echo '<td>'.$data['Building'].'</td><td>'.$data['Location'].'</td><td>'.$data['Address'].'</td><td>'.$data['Fuel'].'</td><td>'.$data['Capacity'].'</td>';
echo'</tr>';
}
echo '</table>';
}
...
<br>
<?php
$result = mysql_query("SELECT * FROM elec_HSC_ABOVEGROUND_DAY_TANK WHERE Building LIKE '%".$thisBuildingCode."%'");
if(mysql_num_rows($result)>0)
{
echo '<h2>Above Ground Day Tank</h2>';
echo '<table CLASS="dispTable">';
echo'<th>Building</th><th>Address</th><th>UsedFor</th><th>Fuel</th><th>Capacity</th>';

while($data = mysql_fetch_array($result))
{
echo'<tr>';
echo '<td>'.$data['Building'].'</td><td>'.$data['Address'].'</td><td>'.$data['UsedFor'].'</td><td>'.$data['Fuel'].'</td><td>'.$data['Capacity'].'</td>';
echo'</tr>';
}
echo '</table>';
}
...
<br>
<?php
$result = mysql_query("SELECT * FROM elec_HSC_ELEVATOR_ABOVEGROUND_HYDRAULICOIL_STORAGE_TANK WHERE Building LIKE '%".$thisBuildingCode."%'");
if(mysql_num_rows($result)>0)
{
echo '<h2>Elevator Above Ground Hydraulic Storage Tank</h2>';
echo '<table CLASS="dispTable">';
echo'<th>Building</th><th>Location</th><th>Address</th><th>Fuel</th><th>Capacity</th>';
...
<br>
<?php
$result = mysql_query("SELECT * FROM elec_HSC_UNDERGROUND_STORAGE_TANK WHERE Building LIKE '%".$thisBuildingCode."%'");
if(mysql_num_rows($result)>0)
{
echo '<h2>Under Ground Storage Tank</h2>';
echo '<table CLASS="dispTable">';
echo'<th>Building</th><th>Address</th><th>UsedFor</th><th>Fuel</th><th>Capacity</th>';
