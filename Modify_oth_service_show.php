    ...
    <div class = "col2">
      ...
      <div Class="sidebar">
          <a class="heading1" href="Modify_data.php">BACK</a>
			...
			<?php
			$query = "SELECT * FROM elec_OTH_SERVICES ORDER BY Feeder_Name ASC";
      ...
      if($result){
        ...
        if($data){
          while($data = mysqli_fetch_assoc($result))
          {
              ...
              echo "<p style='text-align:center;border:2px solid black;border-collapse:collapse;'><b>No OTH Records Found</b></p>";
        }
