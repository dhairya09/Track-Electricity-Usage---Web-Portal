...
<div class="row2">
    ...
    <div class = "col2">
      ...
      <div Class="sidebar">
	      ...
	      $query = "SELECT * FROM view_generators_vlg ORDER BY Bldg ASC";
	      ...
	      if($result){
            ...
            echo'<th>Bldg</th><th>Building</th><th>Equipment</th><th>Nomenclature</th><th>Floor</th><th>kW</th><th>kVA</th><th>Output_Voltage</th><th>Manufacturer</th><th>Mfrd_Year</th><th>Engine_Type</th><th>Fuel_In_Gallons</th><th>Fuel_Type</th><th>Location</th><th>Keyword</th>';
              ...
              echo'</tr>';
	              ...
	              //echo "<p style='text-align:center'><b>No VLG Generator Information Found</b></p>";
                echo "<p style='text-align:center;border-color:black;border-width:2px;border-style:solid;border-collapse:collapse;'><b>No VLG Generator Information Found</b></p>";
	        }
