...
<div class="row2">
    ...
    <div class = "col2">
      ...
      //$query2 = "SELECT T1.Building_Code AS Building, T1.Primary_Feed AS Pri, T1.Secondary_Feed AS Sec, T2.Vault_Name AS Vault, T2.Vault_Section AS Service FROM elec_VLG_TXDEMAND T1 LEFT JOIN elec_VLG_SERVICES T2 ON T1.Primary_Feed = T2.Feeder_Name WHERE T1.Building_Code REGEXP '^[m-z]' ORDER BY 1 ";
      //$result2 = mysqli_query($connection,$query2);

			echo 'VLG SERVICE BY BUILDING';
			echo '<br><br>';
			echo'*Grayed Cell indicates current position of switch<br>';
			echo'<table id="table1" style="width:200%" class="dispServiceTable">';
      ...
      echo '</table>';
			...
			<br>
			<form action="Modify_vlg_servicebybuilding_booklet1.php"><input type="submit" value="VLG ServiceByBuilding Booklet Print"></form>
			<br>
