      ...
      <tr>
        ...
        <?php while($display = mysqli_fetch_assoc($disp)){ ?>
            <tr>
              ...
              <td><a href= "edit_keylocks.php?keylocks=<?php echo urlencode($display["Building_Code"]); ?>">Edit</a></td>
              <td><a href= "delete_keylocks.php?keylocks=<?php echo urlencode($display["Building_Code"]); ?>" onclick="return confirm('Are you sure?');">Delete</a></td>
            </tr>
        <?php } ?>
      </table>
...
?>
        ...
        <a href="new_keylocks.php">Add new KeyInterlocks</a>
        <br/>
