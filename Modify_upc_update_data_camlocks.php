      ...
      <tr>
        ...
        <?php while($display = mysqli_fetch_assoc($disp)){ ?>
            <tr>
              ...
              <td><a href= "edit_camlock.php?camlock=<?php echo urlencode($display["Building_Code"]); ?>">Edit</a></td>
              <td><a href= "delete_camlock.php?camlock=<?php echo urlencode($display["Building_Code"]); ?>" onclick="return confirm('Are you sure?');">Delete</a></td>
            </tr>
        <?php } ?>
      </table>
...
?>
        ...
        <a href="new_camlock.php">Add new CamLock</a>
        <br/>
