...
<div class="row2">
    ...
    <div class = "col2">
      ...
      <br><br>
          ...
          <form action="Modify_upc_mvdistribution_booklet1.php"><input type="submit" value="UPC MVDistribution Booklet Print"></form>
          <br>
          <form action="Modify_usc_mvdistribution_booklet1.php"><input type="submit" value="USC MVDistribution Booklet Print"></form>
