<?php
    ...
    function Booklet_VLG_Data($feeder_che){
    ...
    function Booklet_UOF_Data($feeder_che){
    ...
    function Booklet_HOF_Data($feeder_che){
    ...
    function Booklet_OTH_Data($feeder_che){
    ...
    function Booklet_VLG_Data_Sec($feeder){
      global $connection;
    ...
    function Booklet_UOF_Data_Sec($feeder){
      global $connection;
    ...
    function Booklet_HOF_Data_Sec($feeder){
      global $connection;
    ...
    function Booklet_OTH_Data_Sec($feeder){
      global $connection;
