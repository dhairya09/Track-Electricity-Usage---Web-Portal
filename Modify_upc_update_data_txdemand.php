      ...
      <tr>
        ...
        <?php while($display = mysqli_fetch_assoc($disp)){ ?>
            <tr>
              ...
              <td><a href= "edit_transformer.php?transformer=<?php echo urlencode($display["Building_Code"]); ?>">Edit</a></td>
              <td><a href= "delete_transformer.php?transformer=<?php echo urlencode($display["Building_Code"]); ?>" onclick="return confirm('Are you sure?');">Delete</a></td>
            </tr>
        <?php } ?>
      </table>
